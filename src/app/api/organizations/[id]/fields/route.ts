...
import { updateFieldsSchema } from '@lib/validation/schemas';

// PUT - Update organization fields
export async function PUT(
  ...
  try {
    ...
    const validationResult = updateFieldsSchema.safeParse(body);
    ...
    logger.error('Update fields error', error as Error);
